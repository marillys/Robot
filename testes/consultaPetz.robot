...
Compra de produto
    ...
    Entao exibe a pagina do carrinho com o total de " 384,93"
*** Keywords ***
Dado que acesso o site como cliente
...
Entao exibe a pagina do carrinho com o total de "${preco_total}"
    Wait Until Element Is Enabled    xpath =//div[@data-testid="ptz-bag-resume-subtotal"]   600000ms
    Get Text    xpath =//div[@data-testid="ptz-bag-resume-subtotal"] 
    Element Should Contain    xpath =//div[@data-testid="ptz-bag-resume-subtotal"]   ${preco_total}
